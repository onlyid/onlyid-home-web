/* PrismJS 1.20.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+c+java+kotlin+objectivec+swift */
var _self =
    ...
    Prism = (function(u) {
            ...
            C = {
                ...
                highlightElement: function(e, n, t) {
                    ...
                    l &&
                        ...
                        (l.className =
                            l.className.replace(c, "").replace(/\s+/g, " ") + " language-" + r);
        ...
        if (
            (e && ((C.filename = e.src), e.hasAttribute("data-manual") && (C.manual = !0)),
            !C.manual)
        ) {
