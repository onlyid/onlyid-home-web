...
export default function() {
    return (
        <>
            ...
            <p>
                获取authorization code时，如果使用的redirect
                uri不是你之前控制台预设的，唯ID会提示出错，这是非常重要的安全设计。
            </p>
            <p>
                你应该谨慎设置redirect
                uri，否则可能出现安全隐患。比如说，如果你的网站host在二级域名abc.example.com下，就不应设置主域名example.com为redirect
                uri，否则，不可信的example.com就可能窃取你的用户信息。
            </p>
            <h3>安全存储应用secret</h3>
            <p>
                client
