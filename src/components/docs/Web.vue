<template>
  <div>
    ...
    <p>用户需要登录时，打开授权页：</p>
    <pre>https://my.onlyid.net/authorize?response_type=code&client_id=你的client id
&state=123&redirect_uri=你的redirect uri</pre>
    <note type="info">如果你不知state的作用，可默认传123。</note>
...
redirect_uri=你的redirect uri</pre>
  ...
  "createDate":"2018-04-28T07:27:28.347Z"
    ...
    <h2>结语</h2>
    <p>你已完成网站的接入，接下来还可以在下载中心查阅 <router-link to="/downloads#demo">示例Demo</router-link>，以加深理解。</p>
  </div>
</template>
