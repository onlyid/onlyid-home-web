<template>
  <div>
    ...
    <p>集成SDK。</p>
    <p>或 <a href="https://gitee.com/lltb/onlyid-sdk-ios/tree/master/OnlyID_SDK"
         target="_blank">下载</a>
...
code=获取到的code</pre>
  ...
  "error": "Invalid grant: authorization code is invalid"
    ...
    <h2>结语</h2>
    <p>你已完成接入，接下来还可以查阅 <a href="https://github.com/lltb/onlyid-demo-ios"
         target="_blank">示例Demo</a>，以加深理解。</p>
  </div>
</template>
