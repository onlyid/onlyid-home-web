<template>
  <div>
    ...
    <div class="section content" style="padding-left: 2em; margin-top: 60px;">
      ...
      <h3>唯ID的特点</h3>
      <ol>
        <li><b>开源、自由</b>，自豪地采用GPLv3协议，托管在<a href="https://github.com/lltb" target="_blank">github</a>，所有人可参与贡献，不受大公司控制。</li>
      ...
      <h3>适用范围</h3>
      <p>唯ID是我业余时间发起的项目，没有商业支持。如果你的用户规模超过10万，且对稳定性、安全性要求很高，不建议使用唯ID。唯ID适合：</p>
      <ol>
